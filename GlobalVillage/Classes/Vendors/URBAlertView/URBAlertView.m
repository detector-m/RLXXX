...
//		titleHeight = [self.title sizeWithFont:self.titleFont constrainedToSize:CGSizeMake(layoutWidth, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping].height;
        ...
        NSDictionary *attribute = @{NSFontAttributeName: self.titleFont, NSParagraphStyleAttributeName:paragraphStyle.copy};
        CGSize size = [self.title boundingRectWithSize:CGSizeMake(layoutWidth, CGFLOAT_MAX) options:(NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) attributes:attribute context:nil].size;
...
//		subtitleHeight = [self.subtitle sizeWithFont:self.subtitleFont constrainedToSize:CGSizeMake(layoutWidth, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping].height;
        NSMutableParagraphStyle *paragraphStyle = [[NSMutableParagraphStyle alloc]init];
        paragraphStyle.lineBreakMode = NSLineBreakByWordWrapping;
        NSDictionary *attribute = @{NSFontAttributeName: self.subtitleFont, NSParagraphStyleAttributeName:paragraphStyle.copy};
        CGSize size = [self.subtitle boundingRectWithSize:CGSizeMake(layoutWidth, CGFLOAT_MAX) options:(NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) attributes:attribute context:nil].size;
...
//        paragraphStyle
        NSDictionary *attribute = @{NSFontAttributeName: self.titleFont, NSParagraphStyleAttributeName:paragraphStyle.copy, NSForegroundColorAttributeName:[UIColor whiteColor]};
        [self.title drawWithRect:layout.titleRect options:(NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) attributes:attribute context:nil];
		CGContextRestoreGState(context);
	}
...
//		[self.subtitle drawInRect:layout.subtitleRect withFont:self.subtitleFont lineBreakMode:NSLineBreakByWordWrapping alignment:NSTextAlignmentCenter];
        ...
        paragraphStyle.alignment = NSTextAlignmentCenter;
        //        paragraphStyle
        NSDictionary *attribute = @{NSFontAttributeName: self.subtitleFont, NSParagraphStyleAttributeName:paragraphStyle.copy, NSForegroundColorAttributeName:[UIColor whiteColor]};
        [self.subtitle drawWithRect:layout.subtitleRect options:(NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) attributes:attribute context:nil];
		CGContextRestoreGState(context);
	}	
}
